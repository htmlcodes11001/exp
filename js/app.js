...
const SECCIONES = [
  ...
  },
  {
    ...
    campos: [
      { key: 'queHaConseguido', label: 'Qué ha conseguido de otros peones', placeholder: 'Información, favores, lealtades ganadas...' },
  ...
  },
  {
    ...
    campos: [
      { key: 'otrosPersonajes', label: 'Otros peones relacionados', placeholder: 'Nombres, relaciones, cómo se conecta con el elenco...' },
